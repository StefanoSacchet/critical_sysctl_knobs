...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Custom commands
\usetikzlibrary{shapes, shapes.geometric, arrows, arrows.meta, positioning, fit, backgrounds, calc}
\captionsetup[figure]{font=small, labelfont=bf, skip=10pt} % better caption spacing
\pgfplotsset{compat=1.18}
% This configures the listings to look nice and fit on the page
\lstset{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
      ...
      \input{chapters/3_problem_statement}
      \input{chapters/4_methodology}
      \input{chapters/5_evaluation}
      \input{chapters/6_future_work}
